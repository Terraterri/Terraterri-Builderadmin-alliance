            ...
            <div className="cardd daimnd-stall">
              ...
              <div className='stall-gapp'>
                ...
                <div className="row mb-3">
                  <div className="col-md-12">
                    <h5 className='mt-3'>Model House</h5>
                  </div>
...
<div className='stal-ent'>
       ...
       <div className='row'>
       <div className="col-md-12">
                    <h5 className='mt-2'>Assign Executives</h5>
                  </div>
       <div className="col-md-4 pr-5">
                    <h6 className="BuildNameCom mb-2">Executive 1</h6>
                    <input
                      type="text"
                      className="form-control"
                      placeholder="Name"
                  ...
                  <div className="col-md-4">
                    <h6 className="BuildNameCom mb-2">Executive 2</h6>
                    <input
                      type="text"
                      className="form-control"
                      placeholder="Size"

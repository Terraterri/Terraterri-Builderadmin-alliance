          ...
          <div className="container">
            ...
            <div className="card cardd">
              ...
              <div className="col-md-12 text-center mt-3 mb-4">
                ...
                <div className="row pac-row mt-2 mb-5">
                    ...
                    <button type="button" className="handleActive" onClick={handleActive} >
                      ...
                      >
                        ...
                        <div className='cont_pack'>
                          ...
                          <h2 className="card__title"><span className="card__titlee">Active Packages</span>
                          </h2>
                        </div>
                      </div>
                    </button>
                      ...
                      <div className={
                        ...
                        <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" className="iconCheck" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <h2 className="card__title3">
                              <span className="card__titlee3">Future Packages</span>
                          </h2>
                        </div>
                      </div>
                    </button>
                  ...
                  <div className="col-md-6 col-lg-4">
                    <button type="button" className="handleActive" onClick={handleExpired}>
                      <div className={
                        ...
                        <div className="dashboard-widget-info">
                        <div className='cont_pack'><svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" className="iconCheck" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                            ...
                            </svg><h5>{expiredPackageCount}</h5></div>
                          <h2 className="card__title2">
                            &nbsp; <span className="card__titlee2">Expired Packages</span>
                          </h2>
                        </div>
                      </div>
                    </button>
                ...
                <div className='package_dt'>
                  {selectedPackage != null &&
                    ...
                    <div className="row mt-0 pt-0 pacRow">
                      <div className="col-md-6">
                        ...
                        <button onClick={() => getProjectsByPackage(selectedPackage.purchase_id, 'I')} class="actve_btn">Active Listings</button>
                        <button onClick={() => getProjectsByPackage(selectedPackage.purchase_id, 'A')} class="actve_btnn">Pending Listings</button>
                        {/* <button onClick={() => getProjectsByPackage(selectedPackage.purchase_id, 'R')}>Re-submit</button> */}
                      </div>
                      </div>

                      <div className="col-md-6 ActiveExpires">
                        <span className="mr-3">
                        ...
                        {projects.length > 0 ?
                          projects.map((item, index) => (
                            <tr className="listTBody" key={index}>
                              ...
                              <td className="highlighted40"><Link to={`/package/responses/${item?.id}`}>40</Link></td>
                              <td className="highlighted40"><Link to={`/package/responses/${item?.id}`}>20</Link></td>
                              <td className="highlighted40"><Link to={`/package/responses/${item?.id}`}>20</Link></td>
                              <td>
